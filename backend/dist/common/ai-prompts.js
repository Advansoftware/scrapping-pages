...
exports.SCRAPER_SYSTEM_PROMPT = void 0;
...
exports.SCRAPER_SYSTEM_PROMPT = `Você é um especialista em web scraping.
...
function buildGeneratePrompt(html) {
...
function buildUpdatePrompt(html, previousSelectors, failedFields) {
